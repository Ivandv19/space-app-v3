export const noticias = [
    {
        id: 1,
        title: "Exploración en Marte: Nuevos Descubrimientos",
        explanation:
            "La NASA ha encontrado señales de agua subterránea en Marte, lo que podría cambiar la forma en que entendemos el planeta rojo.",
        content:
    ...
    {
        id: 2,
        title: "La Misión Artemis I: Un Paso Más Cerca de la Luna",
        explanation:
            "La NASA ha completado con éxito el primer vuelo de prueba del cohete SLS y la cápsula Orion en la misión Artemis I.",
        content:
    ...
    {
        id: 3,
        title: "Astrónomos Detectan un Pulsar en una Supernova",
        explanation:
            "Un equipo de astrónomos ha descubierto un pulsar en el remanente de una explosión de supernova, ofreciendo nueva información sobre estos fenómenos.",
        content:
    ...
    {
        id: 4,
        title: "La Primera Imagen de un Agujero Negro Supermasivo",
        explanation:
            "Un equipo internacional de científicos ha logrado capturar la primera imagen de un agujero negro supermasivo en el centro de la galaxia M87.",
        content:
        ...
        keywords: ["agujero negro", "M87", "Event Horizon Telescope", "astrofísica"],
        views: 2891,
    },
    {
        id: 5,
        title: "Detectan Olas Gravitacionales de una Colisión de Estrellas de Neutrones",
        explanation:
            "Científicos han observado ondas gravitacionales producidas por la fusión de dos estrellas de neutrones, proporcionando nuevas pistas sobre el universo.",
        content:
        ...
        categoria: "Astrofísica",
        keywords: ["ondas gravitacionales", "estrellas de neutrones", "astronomía", "colisión"],
        views: 3615,
    },
    {
        id: 6,
        title: "Innovaciones en Satélites para la Observación de la Tierra",
        explanation:
            "Nuevos satélites están siendo lanzados para mejorar la vigilancia y el estudio de la Tierra desde el espacio.",
        content:
        ...
        keywords: ["satélites", "observación terrestre", "cambio climático", "tecnología"],
        views: 7543,
    },
];
