    ...
    switch (action.type) {
        case actionTypes.TOGGLE_LIKE: {
            ...
            if (newLikedImages.some(likedImage => likedImage.date === image.date)) {
                ...
                newLikedImages = newLikedImages.filter(likedImage => likedImage.date !== image.date);
        ...
        case actionTypes.TOGGLE_SAVE: { // Manejo de la acción para alternar "guardar"
            ...
            if (newSavedImages.some(savedImage => savedImage.date === image.date)) {
                newSavedImages = newSavedImages.filter(savedImage => savedImage.date !== image.date); // Elimina si ya está guardada
            } else {
